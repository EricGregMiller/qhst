...
document.writeln('  <tr> ');
document.writeln('    <td colspan="2" background="' + gButtonImagePath + 'topbg.jpg"><img src="' + gButtonImagePath + 'top1.jpg" width="383" height="92"></td>');
document.writeln('  </tr>');
document.writeln('  <tr> ');
document.writeln('    <td width="11%" background="' + gButtonImagePath + 'left.jpg" valign="top"> ');
document.writeln('      <p><img src="' + gButtonImagePath + 'lefttop.jpg" width="151" height="134"><br>');
