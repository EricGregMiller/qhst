...
sub handler 
{
  ...
  { # Could not find input file -- build error page.
    ...
    print ("    <p>You tried to get to $ruri.\n");
    ...
    print ("       inconvenience. Feel feel to contact our <a HREF=\"mailto:eric\@theology.edu\"> web administrator</a> about it.\n");
    print ("    </p>\n");
