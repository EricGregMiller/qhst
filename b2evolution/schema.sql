-- MySQL dump 8.23
--
-- Host: localhost    Database: test_b2evolution
---------------------------------------------------------
...
INSERT INTO `evo_blogs` VALUES (1,'Blog All','Blog All Title','Tagline for Blog All','Short description for Blog All','This is the long description for the blog named \'Blog All\'. <br />\r\n<br />\r\n<strong>This blog (blog #1) is actually a very special blog! It automatically aggregates all posts from all other blogs. This allows you to easily track everything that is posted on this system. You can hide this blog from the public by unchecking \'Include in public blog list\' in the blogs admin.</strong>','en-US','index.php','','all.html','all','Notes for Blog All','Keywords for Blog All',1,1,0,0,1,0,'custom',0,1,1,4,'');
INSERT INTO `evo_blogs` VALUES (2,'Blog A','Blog A Title','Tagline for Blog A','Short description for Blog A','This is the long description for the blog named \'Blog A\'. ','en-US','index.php','','a.html','a','Notes for Blog A','Keywords for Blog A',1,1,0,0,1,0,'custom',0,1,1,4,'');
INSERT INTO `evo_blogs` VALUES (3,'Blog B','Blog B Title','Tagline for Blog B','Short description for Blog B','This is the long description for the blog named \'Blog B\'. ','en-US','index.php','','b.html','b','Notes for Blog B','Keywords for Blog B',1,1,0,0,1,0,'custom',0,1,1,4,'');
INSERT INTO `evo_blogs` VALUES (4,'Linkblog','Linkblog Title','Tagline for Linkblog','Short description for Linkblog','This is the long description for the blog named \'Linkblog\'. <br />\r\n<br />\r\n<strong>The main purpose for this blog is to be included as a side item to other blogs where it will display your favorite/related links.</strong>','en-US','index.php','','links.html','links','Notes for Linkblog','Keywords for Linkblog',1,1,0,0,1,0,'custom',0,1,1,0,'');
...
INSERT INTO `evo_comments` VALUES (1,1,'comment','published',NULL,'miss b2','missb2@example.com','http://example.com','127.0.0.1','2005-07-26 10:31:38','Hi, this is a comment.<br />To delete a comment, just log in, and view the posts\' comments, there you will have the option to edit or delete them.',0);
...
INSERT INTO `evo_users` VALUES (1,'admin','cd5686049171d76de7302801d144054c','','','admin',0,'robin@theology.edu','','127.0.0.1','localhost','',NOW(),10,'','','','en-US','login',1,1);
