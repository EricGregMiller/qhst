 ...
 */
define( 'DB_USER', 'usr57da745114eb' );      // your MySQL username
define( 'DB_PASSWORD', 'heretic' );  // ...and password
define( 'DB_NAME', 'mysql3a322eb50db0d522fe37bb6cde8' );   // the name of the database
 ...
 */
$baseurl = 'http://theology.edu/b2evolution';		// IMPORTANT: NO ENDING SLASH !!!
 ...
 */
$admin_email = 'robin@theology.edu';
