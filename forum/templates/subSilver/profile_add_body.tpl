...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post" id="ProfileAddForm">
...
<div>
{VALIDATING_SCREEN}
<input type="button" value="{L_SUBMIT}" class="mainoption" {ON_CLICK_SCRIPT}/>&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" />
</div>
</td>
	</tr>
</table>
