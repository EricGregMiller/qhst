var gMap;
// http://www.gmap-pedometer.com/?r=626858
var gHappyIslesRouteData;
// http://www.gmap-pedometer.com/?r=626843
var gGlacierPointRouteData;
// http://www.gmap-pedometer.com/?r=626461
var gSentinelDomeRouteData;
// http://www.gmap-pedometer.com/?r=626637
...
function ComputeTrailDistance(iDistance, iDistanceType) 
{
  ...
  case "GlacierPoint":
    ...
    if (iDistanceType == "HappyIsles")
    {
      if (iDistance >= 3.4)
      {
        oDist.Out = iDistance + 4.8 - 3.4;
        if (iDistance < 8.2)
          oDist.Back = 17.8 - iDistance;
      }
      else
      {
        oDist.Out = 17.8 - iDistance;
      }
    }
    break;
  case "SentinelDome":
...
function MouseOverButton(iButton) 
{
  ...
  case "LittleYosemiteCampground":
    //ShowInformation(iButton.innerHTML, 4.3, 'HappyIsles', 6120, 'Designated campsite for backpackers');
    break;
  case "LittleYosemiteValley":
    // El: 1865.18092
    // (TopoZone 37.73306, -119.51028, unknown)
    ShowInformation({ Lat: 37.73216, 
                      Lon: -119.51494, 
                      LocationName: iButton.innerHTML, 
                      Distance: 4.9, 
                      DistanceType: 'HappyIsles', 
