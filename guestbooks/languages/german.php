...
$gbadd_msg		= "Nachricht :";
$ad_pages		= "Seiten :";
$smiliehelp		= "Klicken Sie hier, für Smilie-Code Hilfe";
$smiley_help		= "Smilie Hilfe";
$urlcodehelp		= "Klicken Sie hier, für URL-Code Hilfe";
$url_code_help		= "URL Code Hilfe";
$submit			= "Abschicken";
$location_sel		= "-------- bitte auswählen --------";
...
$banned			= "Flutschutz aktiv, bitte probieren Sie es später nocheinmal !";
$moderator_del_entry	= "MODERATOR Eintrag löschen";
$moderator_del_comment	= "MODERATOR Kommentar löschen";
$moderator_edit_comment	= "MODERATOR Kommentar editieren";
$gb_notifysubj		= "INFO-Neuer Eintrag im Gästebuch";
